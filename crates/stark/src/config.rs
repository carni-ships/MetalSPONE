...
pub trait StarkGenericConfig: 'static + Send + Sync + Serialize + DeserializeOwned + Clone {
    ...
    type Domain: PolynomialSpace<Val = Self::Val>
        + Sync
        + Into<TwoAdicMultiplicativeCoset<Self::Val>>;
    ...
    type Pcs: Pcs<Self::Challenge, Self::Challenger, Domain = Self::Domain>
        ...
        + PcsOpenSequential<
            ...
            Self::Challenge,
            Self::Challenger,
            Proof = <Self::Pcs as Pcs<Self::Challenge, Self::Challenger>>::Proof,
            ProverData = <Self::Pcs as Pcs<Self::Challenge, Self::Challenger>>::ProverData,
        >;
